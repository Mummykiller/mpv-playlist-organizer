...
(() => {
	...
	window.MPV_INTERNAL.UIManager = class UIManager {
		...
		createAndInjectUi() {
			...
			const isScanner = window.location.search.includes(
				"mpv_playlist_scanner=true",
			);
			...
			const minimizedShadowRoot = this.minimizedHost.attachShadow({
				mode: "open",
			});
			...
			this.anilistShadowRoot = this.anilistPanelHost.attachShadow({
				mode: "open",
			});
			...
			anilistPanelWrapper.innerHTML = `
                ...
                <div class="anilist-nav-controls">
                    <button id="btn-anilist-prev" class="anilist-nav-btn" title="Previous Day">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>
                    </button>
                    <button id="btn-anilist-today" class="anilist-nav-btn today-btn">Today</button>
                    <button id="btn-anilist-next" class="anilist-nav-btn" title="Next Day">
		...
		teardown() {
			...
			this.controllerHost =
				this.shadowRoot =
				this.minimizedHost =
				this.anilistPanelHost =
				this.anilistShadowRoot =
				this.hostStyle =
					null;
		}
	};

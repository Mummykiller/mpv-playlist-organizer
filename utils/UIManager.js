...
class UIManager {
    ...
    createAndInjectUi() {
        ...
        anilistPanelWrapper.innerHTML = `
            <link rel="stylesheet" type="text/css" href="${cssUrl}">
            <div class="anilist-panel-header"><button id="btn-refresh-anilist" class="anilist-refresh-btn" title="Refresh Releases"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 2v6h6"/><path d="M21 12A9 9 0 0 0 6 5.3L3 8"/><path d="M21 22v-6h-6"/><path d="M3 12a9 9 0 0 0 15 6.7l3-2.7"/></svg></button><p class="anilist-release-delay-info">Note: There may be a 30 minute to 3 hour delay on release times.</p><button id="btn-close-anilist-panel" title="Close Panel">&times;</button></div>
